...
\node[nfrisk] (f) at (4.0,-2.1) {Held for review};
\draw[nfedge] (a)--(b); \draw[nfedge] (b)--(c); \draw[nfedge] (c)--(d);
\draw[nfedge] (d) to[out=-90,in=20, looseness=1] (e.east);
\draw[nfedged] (b) to[out=-90,in=120, looseness=0.4] (f.north);
\end{narrativefig}
\vspace{-0.75cm}
\figcaption{Figure 8. Safeguards written into procedure: parity, consent, and audit each guard the accept, or hold the work.}
...
\footnotesize
\begin{tabularx}{\textwidth}{@{}L{4.7cm} Y L{4.0cm}@{}}
\toprule
